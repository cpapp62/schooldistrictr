(function (global, factory) {
  ...
  function createTitle(cluster) {
    var title = cluster["name"],
        clusterID = cluster["id"],
        description = cluster["description"];
    return html(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        <h2 class=\"cluster-page__header\">Cluster ", " \u2013 ", "</h2>\n        <p class=\"cluster-page__description\">", "</p>\n    "])), clusterID, title, description);
  }
  /**
  ...
  function renderClusterDataView() {
    // Grab the cluster information and create a title.
    var _JSON$parse = JSON.parse(window.localStorage.getItem("coidata")),
        cluster = _JSON$parse.cluster,
        portal = _JSON$parse.portal,
        titleEntity = Array.from(document.getElementsByClassName("title"))[0],
        title = createTitle(cluster); // Render the title.


    render(title, titleEntity); // Create a DataTable.

    var tableEntity = Array.from(document.getElementsByClassName("table-container"))[0],
        variableNames = ["Portal Link", "Overall Submission Information", "Individual Area Information"],
        table;
    table = html(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n        <table class=\"data-table\">\n            <col style=\"width: 7%\">\n            <col style=\"width: 46%\">\n            <col style=\"width: 46%\">\n            <thead>\n                ", "\n            </thead>\n            <tbody>\n                ", "\n            </tbody>\n        </table>\n    "])), variableNames.map(function (name) {
      return html(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<th class=\"data-table__column-heading\" colSpan=1>", ""])), name);
    }), cluster["submissions"].map(function (s) {
      var description = s["description"] == "0" ? html(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["<i style=\"font-size: 0.8em\">No description provided.</i>"]))) : s["description"],
          areaText = s["areatext"] == "0" | s["areatext"] == "" ? html(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["<i style=\"font-size: 0.8em\">No description provided.</i>"]))) : s["areatext"];
      return html(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n                            <tr>\n                                <td class=\"ui-data data-table__cell\" style=\"text-align: center;\">\n                                    <a target=\"_blank\" href=\"", "/submission/", "\">", "</a>\n                                </td>\n                                <td class=\"ui-data data-table__cell\" style=\"padding: 0.9em; font-size: 0.9em; text-align: left;\">\n                                    <strong>", ".</strong> ", "\n                                </td>\n                                <td class=\"ui-data data-table__cell\" style=\"padding: 0.9em; font-size: 0.9em; text-align: left;\">\n                                    <strong>", ".</strong> ", "\n                                </td>\n                            </tr>\n                        "])), portal, s['cluster_id'], s['cluster_id'], s['title'], description, s['areaname'], areaText);
    })); // Render the table.

    render(table, tableEntity);
  }

  return renderClusterDataView;
