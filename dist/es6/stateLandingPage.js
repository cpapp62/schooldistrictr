(function (global, factory) {
  ...
  function getAllUnits(place, problem) {
  ...
  var stateLandingPage = (function () {
    ...
    fetch("/assets/data/landing_pages.json?v=2").then(function (response) {
      ...
      statePlaces.then(function (ps) {
        ...
        var toggleViz = function toggleViz(id) {
  ...
  var drawSection = function drawSection(section, stateData, onlyCommunities) {
    ...
    if (section.type === "draw") {
      ...
      })) : "", section.content ? $.parseHTML(section.content) : "", section.subsections ? section.subsections.map(function (s) {
        return html(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["<h3>", "</h3>\n                                                                      ", "\n                                                                       ", ""])), s.name, s.content_source ? until(fetch(s.content_source).then(function (r) {
          if (r.status === 200) {
            return r.text();
          } else if (userRequested) {
  ...
  var placeItemsTemplate = function placeItemsTemplate(places, onClick) {
    ...
    return places.sort(function (a, b) {
      ...
      return place.elemProblems.sort(function (a, b) {
        ...
        return showAll || !problem.hideOnDefault;
      }).map(function (problem) {
        return getAllUnits(place, problem).filter(function (unit) {
          return showAll || !unit.hideOnDefault;
        }).map(function (units) {
