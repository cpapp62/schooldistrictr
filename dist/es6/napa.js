(function (global, factory) {
  ...
  var napa = (function () {
    listPlacesForState("California").then(function (places) {
      var target = document.getElementById("districting-options");
      render(districtingOptions(places), target);
      var target2 = document.getElementById("districting-options-2");
      render(districtingOptions(places.filter(function (p) {
        return p.id === "napaschools";
      })), target2);
    });
  ...
  var loadablePlan = function loadablePlan(plan) {
    return html(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n    <a href=\"/napa/", "\">\n        <li class=\"plan-thumbs__thumb\">\n            <img\n                class=\"thumb__img\"\n                src=\"/assets/napa-plans/", ".png?v=2\"\n                alt=\"Districting Plan ", "\"\n            />\n            <figcaption class=\"thumb__caption\">\n                <h6 class=\"thumb__heading\">", "</h6>\n                ", "\n                ", "\n            </figcaption>\n        </li>\n    </a>\n"])), plan.id, plan.id, plan.id, plan.name || plan.id, plan.description ? plan.description : "", plan.numbers ? numberList(plan.numbers) : "");
  };
  ...
  var placeItemsTemplate = function placeItemsTemplate(place, onClick) {
    return place.districtingProblems.map(function (problem) {
      return getUnits(place, problem).map(function (units) {
        ...
        }, problem.numberOfParts, problem.pluralNoun, units.unitType);
      });
